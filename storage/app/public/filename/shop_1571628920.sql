...
-- Dumping structure for table shop.affiliates
...
-- Dumping data for table shop.affiliates: ~0 rows (approximately)
/*!40000 ALTER TABLE `affiliates` DISABLE KEYS */;
/*!40000 ALTER TABLE `affiliates` ENABLE KEYS */;

-- Dumping structure for table shop.affiliates_config
...
-- Dumping data for table shop.affiliates_config: ~5 rows (approximately)
...
-- Dumping structure for table shop.auth_logs
...
-- Dumping data for table shop.auth_logs: ~343 rows (approximately)
...
-- Dumping structure for table shop.balance_logs
...
-- Dumping data for table shop.balance_logs: ~0 rows (approximately)
...
-- Dumping structure for table shop.blocks
...
-- Dumping data for table shop.blocks: ~0 rows (approximately)
...
-- Dumping structure for table shop.block_content
...
-- Dumping data for table shop.block_content: ~2 rows (approximately)
...
-- Dumping structure for table shop.catalogs
...
-- Dumping data for table shop.catalogs: ~9 rows (approximately)
...
-- Dumping data for table shop.category: ~2 rows (approximately)
...
-- Dumping structure for table shop.category_product
...
-- Dumping data for table shop.category_product: ~17 rows (approximately)
...
-- Dumping data for table shop.currencies: ~3 rows (approximately)
...
-- Dumping structure for table shop.currencies_code
...
-- Dumping data for table shop.currencies_code: ~154 rows (approximately)
...
-- Dumping structure for table shop.funds
CREATE TABLE IF NOT EXISTS `funds` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `code` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '113',
  `key` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'TM113',
  `description` text COLLATE utf8_unicode_ci,
  `balance` double NOT NULL,
  `curreny_id` int(11) NOT NULL,
  `currency_code` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT '1' COMMENT 'Sở hữu, admin',
  `status` int(11) DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Quỹ tiền';

-- Dumping data for table shop.funds: ~0 rows (approximately)
/*!40000 ALTER TABLE `funds` DISABLE KEYS */;
/*!40000 ALTER TABLE `funds` ENABLE KEYS */;

-- Dumping structure for table shop.funds_logs
CREATE TABLE IF NOT EXISTS `funds_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'THU, CHI',
  `from_fund` int(11) NOT NULL,
  `to_fund` int(11) DEFAULT NULL,
  `receiver` int(11) DEFAULT NULL COMMENT 'người nhận',
  `receiver_info` text COLLATE utf8_unicode_ci,
  `net_amount` double unsigned NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Lịch sử quỹ';

-- Dumping data for table shop.funds_logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `funds_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `funds_logs` ENABLE KEYS */;

-- Dumping structure for table shop.giftcodes
...
-- Dumping data for table shop.giftcodes: ~10 rows (approximately)
...
-- Dumping structure for table shop.giftcode_logs
...
-- Dumping data for table shop.giftcode_logs: ~8 rows (approximately)
...
-- Dumping structure for table shop.groups
...
-- Dumping data for table shop.groups: ~3 rows (approximately)
...
-- Dumping structure for table shop.inventory
CREATE TABLE IF NOT EXISTS `inventory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  `product_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `location` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `stock_id` tinyint(4) NOT NULL,
  `amount` double NOT NULL DEFAULT '0' COMMENT 'Số hàng tồn',
  `production_date` timestamp NULL DEFAULT NULL,
  `expiration_date` timestamp NULL DEFAULT NULL,
  `unit` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Đơn vị tính',
  `volume` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'thể tích m3 của 1 unit',
  `weight` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'khối lượng 1 unit',
  `color` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'các thuộc tính cơ bản',
  `size` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'các thuộc tính cơ bản',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Quản lý kho hàng hóa';

-- Dumping data for table shop.inventory: ~0 rows (approximately)
/*!40000 ALTER TABLE `inventory` DISABLE KEYS */;
INSERT INTO `inventory` (`id`, `product_id`, `product_name`, `location`, `stock_id`, `amount`, `production_date`, `expiration_date`, `unit`, `volume`, `weight`, `color`, `size`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Sandora Đào', 'Hà Nội', 1, 1000, NULL, NULL, 'hop', NULL, NULL, NULL, NULL, '2019-09-27 14:22:54', '2019-09-27 14:22:54');
/*!40000 ALTER TABLE `inventory` ENABLE KEYS */;

-- Dumping structure for table shop.inventory_logs
CREATE TABLE IF NOT EXISTS `inventory_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Lệnh',
  `user_id` int(11) NOT NULL COMMENT 'người lập phiếu',
  `userinfo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `order_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Mã đơn hàng',
  `from_stock` int(11) NOT NULL COMMENT 'từ kho nào',
  `to_stock` int(11) DEFAULT NULL COMMENT 'đến kho nào',
  `customer` int(11) DEFAULT NULL COMMENT 'id người nhận nếu là thành viên web',
  ...
  `currency_code` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT '99' COMMENT 'chờ 99, thành công 1..',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_number` (`order_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Lịch sử xuất nhập kho';

-- Dumping data for table shop.inventory_logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `inventory_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `inventory_logs` ENABLE KEYS */;

-- Dumping structure for table shop.inventory_stock
CREATE TABLE IF NOT EXISTS `inventory_stock` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `city` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `country` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'VN',
  `address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `contact_phone` double DEFAULT NULL,
  `contact_name` double DEFAULT NULL,
  `total_volume` double DEFAULT NULL,
  `total_weight` double DEFAULT NULL,
  `free_volume` double DEFAULT NULL,
  `free_weight` double DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Kho';

-- Dumping data for table shop.inventory_stock: ~2 rows (approximately)
/*!40000 ALTER TABLE `inventory_stock` DISABLE KEYS */;
INSERT INTO `inventory_stock` (`id`, `name`, `city`, `country`, `address`, `contact_phone`, `contact_name`, `total_volume`, `total_weight`, `free_volume`, `free_weight`, `created_at`, `updated_at`) VALUES
	(1, 'Kho Cảng cạn DHL', 'Hà Nội', 'VN', '3 Tôn Thất Thuyết, Dịch Vọng, Cầu Giấy', NULL, NULL, NULL, NULL, NULL, NULL, '2019-09-27 14:04:42', '2019-09-27 14:04:42'),
	(2, 'Kho Trần Thái Tông', 'Hà Nội', 'VN', '35/45 Trần Thái Tông, Dịch Vọng, Cầu Giấy', NULL, NULL, NULL, NULL, NULL, NULL, '2019-09-27 14:04:42', '2019-09-27 14:04:42');
/*!40000 ALTER TABLE `inventory_stock` ENABLE KEYS */;

-- Dumping structure for table shop.inventory_unit
...
-- Dumping data for table shop.inventory_unit: ~2 rows (approximately)
/*!40000 ALTER TABLE `inventory_unit` DISABLE KEYS */;
INSERT INTO `inventory_unit` (`id`, `name`, `key`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'Hộp', 'hop', 'Hộp nước ép', '2019-09-27 12:46:04', '2019-09-27 12:46:04'),
	(2, 'Thùng', 'thung', 'Thùng nước ép', '2019-09-27 12:46:24', '2019-09-27 12:46:24');
/*!40000 ALTER TABLE `inventory_unit` ENABLE KEYS */;

-- Dumping structure for table shop.inventory_unit_convert
CREATE TABLE IF NOT EXISTS `inventory_unit_convert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL COMMENT 'Quy cách đóng gói theo sản phẩm gì',
  `from_unit` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'key',
  `from_unit_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `to_unit` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `to_unit_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `value` double NOT NULL DEFAULT '1' COMMENT 'gia tri quy doi',
  `checksum` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'md5(from_unit+to_unit+product_id)',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table shop.inventory_unit_convert: ~0 rows (approximately)
/*!40000 ALTER TABLE `inventory_unit_convert` DISABLE KEYS */;
INSERT INTO `inventory_unit_convert` (`id`, `product_id`, `from_unit`, `from_unit_name`, `to_unit`, `to_unit_name`, `value`, `checksum`, `created_at`, `updated_at`) VALUES
	(1, 0, 'thung', 'Thùng', 'hop', 'hop', 10, '0', '2019-09-27 12:47:08', '2019-09-27 12:47:08');
/*!40000 ALTER TABLE `inventory_unit_convert` ENABLE KEYS */;
...
-- Dumping structure for table shop.languages_trans
...
-- Dumping data for table shop.languages_trans: ~167 rows (approximately)
...
-- Dumping structure for table shop.localbanks
...
-- Dumping data for table shop.localbanks: ~3 rows (approximately)
...
-- Dumping structure for table shop.localbanks_user
...
-- Dumping data for table shop.localbanks_user: ~2 rows (approximately)
...
-- Dumping structure for table shop.ltm_translations
...
-- Dumping data for table shop.ltm_translations: ~139 rows (approximately)
...
-- Dumping structure for table shop.menu
...
-- Dumping data for table shop.menu: ~12 rows (approximately)
...
-- Dumping structure for table shop.merchants
...
-- Dumping data for table shop.merchants: ~0 rows (approximately)
...
-- Dumping structure for table shop.model_has_permissions
...
-- Dumping data for table shop.model_has_permissions: ~2 rows (approximately)
...
-- Dumping structure for table shop.model_has_roles
...
-- Dumping data for table shop.model_has_roles: ~5 rows (approximately)
...
-- Dumping data for table shop.news: ~0 rows (approximately)
...
-- Dumping structure for table shop.notification
...
-- Dumping data for table shop.notification: ~0 rows (approximately)
...
-- Dumping data for table shop.orders: ~19 rows (approximately)
...
-- Dumping data for table shop.order_items: ~0 rows (approximately)
...
-- Dumping data for table shop.pages: ~0 rows (approximately)
...
-- Dumping structure for table shop.paygates
...
-- Dumping data for table shop.paygates: ~4 rows (approximately)
...
-- Dumping structure for table shop.paygates_logs
...
-- Dumping data for table shop.paygates_logs: ~2 rows (approximately)
...
-- Dumping structure for table shop.permissions
...
-- Dumping data for table shop.permissions: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `product_uri` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'chuỗi đứng trước url_key',
...
-- Dumping structure for table shop.product_gallery
...
-- Dumping data for table shop.product_gallery: ~12 rows (approximately)
...
-- Dumping structure for table shop.product_option
...
-- Dumping data for table shop.product_option: ~0 rows (approximately)
/*!40000 ALTER TABLE `product_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_option` ENABLE KEYS */;

-- Dumping structure for table shop.product_option_value
CREATE TABLE IF NOT EXISTS `product_option_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `option_id` int(11) NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `option_price` decimal(12,4) DEFAULT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table shop.product_option_value: ~0 rows (approximately)
/*!40000 ALTER TABLE `product_option_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_option_value` ENABLE KEYS */;

-- Dumping structure for table shop.product_price
...
-- Dumping data for table shop.product_price: ~3 rows (approximately)
...
INSERT INTO `product_price` (`id`, `group`, `product_id`, `price`, `currency_id`, `currency_code`, `checksum`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, 65000, 1, 'VND', NULL, '2019-09-27 14:10:22', '2019-09-27 14:10:22'),
	(2, 3, 1, 54400, 1, 'VND', NULL, '2019-09-27 14:10:42', '2019-09-27 14:10:42'),
	(3, 2, 2, 65000, 1, 'VND', NULL, '2019-09-27 14:11:09', '2019-09-27 14:11:09');
...
-- Dumping data for table shop.roles: ~4 rows (approximately)
...
-- Dumping structure for table shop.role_has_permissions
...
-- Dumping data for table shop.role_has_permissions: ~16 rows (approximately)
...
-- Dumping structure for table shop.sendform
...
-- Dumping data for table shop.sendform: ~0 rows (approximately)
/*!40000 ALTER TABLE `sendform` DISABLE KEYS */;
/*!40000 ALTER TABLE `sendform` ENABLE KEYS */;

-- Dumping structure for table shop.sendform_fields
...
-- Dumping data for table shop.sendform_fields: ~2 rows (approximately)
...
-- Dumping structure for table shop.sendmail_driver
...
-- Dumping data for table shop.sendmail_driver: ~2 rows (approximately)
...
-- Dumping structure for table shop.sendmail_setting
...
-- Dumping data for table shop.sendmail_setting: ~0 rows (approximately)
...
-- Dumping data for table shop.seo: ~5 rows (approximately)
...
-- Dumping data for table shop.settings: ~47 rows (approximately)
...
-- Dumping structure for table shop.settings_meta
...
-- Dumping data for table shop.settings_meta: ~5 rows (approximately)
...
-- Dumping structure for table shop.settings_module
...
-- Dumping data for table shop.settings_module: ~9 rows (approximately)
...
-- Dumping data for table shop.sliders: ~4 rows (approximately)
...
-- Dumping structure for table shop.slugs
...
-- Dumping data for table shop.slugs: ~2 rows (approximately)
...
-- Dumping structure for table shop.sms
...
-- Dumping data for table shop.sms: ~8 rows (approximately)
...
-- Dumping structure for table shop.sms_provider
...
-- Dumping data for table shop.sms_provider: ~0 rows (approximately)
...
-- Dumping structure for table shop.tags
...
-- Dumping data for table shop.tags: ~0 rows (approximately)
...
-- Dumping structure for table shop.ticket
...
-- Dumping data for table shop.ticket: ~3 rows (approximately)
...
-- Dumping structure for table shop.ticket_fields
...
-- Dumping data for table shop.ticket_fields: ~3 rows (approximately)
...
-- Dumping structure for table shop.ticket_reply
...
-- Dumping data for table shop.ticket_reply: ~6 rows (approximately)
...
-- Dumping structure for table shop.tmp
...
-- Dumping data for table shop.tmp: ~0 rows (approximately)
/*!40000 ALTER TABLE `tmp` DISABLE KEYS */;
/*!40000 ALTER TABLE `tmp` ENABLE KEYS */;

-- Dumping structure for table shop.twofactors
...
-- Dumping data for table shop.twofactors: ~2 rows (approximately)
...
-- Dumping structure for table shop.uploads
...
-- Dumping data for table shop.uploads: ~0 rows (approximately)
...
-- Dumping structure for table shop.user_discount
...
-- Dumping data for table shop.user_discount: ~0 rows (approximately)
/*!40000 ALTER TABLE `user_discount` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_discount` ENABLE KEYS */;

-- Dumping structure for table shop.user_images
...
-- Dumping data for table shop.user_images: ~3 rows (approximately)
...
-- Dumping structure for table shop.wallets
...
-- Dumping data for table shop.wallets: ~4 rows (approximately)
...
-- Dumping structure for table shop.wallet_fees
...
-- Dumping data for table shop.wallet_fees: ~0 rows (approximately)
...
-- Dumping structure for table shop.wallet_history
...
-- Dumping data for table shop.wallet_history: ~30 rows (approximately)
...
-- Dumping structure for table shop.wallet_settings
...
-- Dumping data for table shop.wallet_settings: ~0 rows (approximately)
...
-- Dumping structure for table shop.weblinks
...
-- Dumping data for table shop.weblinks: ~0 rows (approximately)
...
-- Dumping structure for table shop.web_data
...
-- Dumping data for table shop.web_data: ~18 rows (approximately)
