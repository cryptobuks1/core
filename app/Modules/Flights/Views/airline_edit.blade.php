      ...
      <div class="col-md-12">
           ...
           @include('layouts.errors')
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                {!! Form::model($data, ['method' => 'PATCH','route' => ['flight.airline.update', $data->id],'enctype' => 'multipart/form-data']) !!}
                <div class="card-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tên hãng bay(<span class="red">*</span>):</label>
                            <input type="text" name="name" class="form-control" placeholder="Nhập tên hãng bay" required value="{{$data->name or old('name')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="local" id="" class="form-control">
                                <option value="1" @if($data->local == 1) selected @endif>Hãng bay trong nước</option>
                                <option value="2" @if($data->local == 2) selected @endif>Hãng bay ngoài nước</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" id="" class="form-control" placeholder="Nhập mã code" style="text-transform: uppercase" maxlength="10" required value="{{$data->code or old('code')}}">
                        </div>
                    </div>
