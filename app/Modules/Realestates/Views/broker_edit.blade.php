        ...
        <div class="create-broker">
            ...
            <div id="main-create-broker" class="container">
                <div class="content-wap">
                    ...
                    {!! Form::model($broker, ['method' => 'PATCH','route' => ['broker.update', $broker->id],'enctype'=>'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-md-10">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="website" class="lb-broker">Nổi bật:</label>
                                        <select name="featured" id="" class="form-control">
                                            <option value="1"@if($broker->featured==1) selected @endif>Bật</option>
                                            <option value="0"@if($broker->featured==0) selected @endif>Tắt</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <textarea class="test " name="introduce_show" hidden>
                    </textarea>
                    <div>
                        <button type="submit" class="btn btn-primary">Cập nhật</button>
                        <a href="{{route('broker.index')}}" class="btn btn-warning">Hủy</a>
                    </div>
                    @csrf
                    {!! Form::close() !!}
                    {{--                hết form--}}
