                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="1" @if($cate->status==1) selected @endif>Bật</option>
                                                <option value="0" @if($cate->status==0) selected @endif>Tắt</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <label for="form_id">Trạng thái:</label>
                                            <textarea name="description" id="" cols="30" rows="10" class="form-control">{{$cate->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
