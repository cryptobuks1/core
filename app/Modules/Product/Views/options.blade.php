            ...
            <div class="col-md-5">
                <div class="card card-light">
                    <div class="card-header">
                        <h3 class="card-title">Thêm tùy chọn cho sản phẩm</h3>
                    </div>

                    @include('layouts.errors')

                    {!! Form::open(array('route' => 'backend.product.optionvalue.create','method'=>'POST')) !!}
                    <div class="card-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col-4">
                                    <input class="form-control" value="{{$product->sku}}_" readonly>
                                </div>
                                <div class="col-8">
                                    <input class="form-control" value="" name="sku" id="sku">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="0" name="sort" type="number" id="sort">
                            </div>
                            <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ url($backendUrl.'/product/'.$product->id.'/option/edit/'.$opvalue->id) }}">
