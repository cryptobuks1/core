        ...
        <tr>
          ...
          <td>
            <div class="action-buttons">
             <a href="{{ url($backendUrl.'/permissions/'.$permission->id.'/edit') }}"><span class="btn btn-info btn-sm"> <i title="Sửa" class="ace-icon fa fa-pencil bigger-130"></i> </span></a>
              @can('delete')
             <a href="#" name="{{ $permission->name }}" link="{{ url($backendUrl.'/permissions/'.$permission->id) }}" class="deleteClick red id-btn-dialog2" data-toggle="modal" data-target="#deleteModal" ><span class="btn btn-danger btn-sm"> <i title="Delete" class="ace-icon fa fa-trash-o bigger-130"></i></span></a>
              @endcan
            </div>
          </td>
        </tr>
