      ...
      <div class="col-md-12">
           ...
           @include('layouts.errors')
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::open(array('route' => 'backend.telco.store','method'=>'POST','enctype' => 'multipart/form-data')) !!}
                <div class="card-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tên nhà mạng(<span class="red">*</span>):</label>
                            <input type="text" name="name" placeholder="Nhập tên nhà mạng" class="form-control" value="{{old('name')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="country_code" class="form-control">
                                @foreach($countries as $country)
                                    <option value="{{$country->code}}" @if($country->code == 'VN') selected @endif>{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="key" placeholder="Nhập mã key" class="form-control" value="{{old('key')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Number:</label>
                            <input type="text" name="number_format" placeholder="Nhập number" class="form-control" value="{{old('number_format')}}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                                ...
                                @foreach($currencies as $currency)
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price[{{$group->id}}][{{$currency->code}}]" class="form-control" value="0">
                                        </div>
                                    </div>
                                @endforeach
                            <div class="col-md-12">
