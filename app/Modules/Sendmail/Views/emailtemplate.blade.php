                ...
                <tr>
                    ...
                    <td align="center" valign="top" style="background: #ffffff;">
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                        <img src="{{ $logo }}" alt="img" width="135" border="0" style="display: block; width: 135px;" />
                                    </a>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                                <td align="left" valign="top">
                                    <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 30px; line-height: 24px; letter-spacing: -1.5px;"><strong>Xin chào, {{$name}}</strong></span>
                                        <br>
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 24px;">{!! $content !!}</span>
