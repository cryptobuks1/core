                                ...
                                <div class="input-group input-group-sm dataTables_filter" style="">
                                    <form action="" name="formSearch" method="GET" >
                                        <div class="input-group">
                                            <select name="telco" class="form-control" style="width: 250px;padding: 0; display: flex; padding-top: 10px">
                                                <option value="" @if(app("request")->input("telco")== "") selected="selected" @endif>--Lọc theo nhà mạng--</option>
                                                @foreach($telcos as $telco)
                                                    <option value="{{$telco->id}}" @if(app("request")->input("telco")== $telco->id) selected="selected" @endif>{{$telco->name}}</option>
                                                @endforeach
                                            </select>
                                            <input type="text" class="form-control" style="width: 250px;" placeholder="Từ ngày" id="fromdate" name="fromdate" value="@if(app("request")->input("fromdate")){{ trim(app("request")->input("fromdate"))}}@endif">
                                            <input type="text" class="form-control" style="width: 250px;" placeholder="Đến ngày" id="todate" name="todate" value="@if(app("request")->input("todate")){{ trim(app("request")->input("todate"))}}@endif">
                                            <div class="input-group-append" style="float: right; transform: translateY(-3px)">
