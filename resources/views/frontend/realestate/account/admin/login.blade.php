...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <h4 class="login-box-msg">Quản trị hệ thống</h4>
            <form method="POST" action="{{ route('control.login.admin') }}" aria-label="{{ __('Đăng nhập') }}">
                <div class="form-group has-feedback">
                    <input type="text" name="email" value="{{ old('email') }}" placeholder="Email" class="form-control"
                           id="login" maxlength="80" size="30" required>
